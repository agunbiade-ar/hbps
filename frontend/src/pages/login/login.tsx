...
import './login.scss';
import { FetchMe, SignIn, setUser } from "../../redux/slices/authSlice.tsx";
                ...
                <div className='login-card'>
                    <div className='login-header'>
                        <div className='login-header__icon-group'>
                            <svg className='login-header__icon' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg className='login-header__icon' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.657 18.657A8 8 0 0 1 6.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0 1 20 13a7.975 7.975 0 0 1-2.343 5.657z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M9.879 16.121A3 3 0 1 0 12.015 11L11 14H9c0 .768.293 1.536.879 2.121z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                        <h1 className='login-header__title'>Welcome Back</h1>
                        <p className='login-header__subtitle'>Sign in to access your healthcare management system</p>
                    </div>
                        ...
                        <div className='login-footer__features'>
                            <div className='login-footer__feature'>
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 8h14M3 12h14M7 4v12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                                </svg>
                                <span>Billing</span>
                            </div>
                            <div className='login-footer__feature'>
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M7 5V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v1M10 9v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                                </svg>
                                <span>Inventory</span>
                            </div>
                            <div className='login-footer__feature'>
                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14 13a4 4 0 0 1-8 0c0-2.5 2-4 4-4s4 1.5 4 4z" stroke="currentColor" strokeWidth="1.5"/>
                                    <path d="M10 9V5M8 7l2-2 2 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                                <span>Pharmacy</span>
                            </div>
                        </div>
